  ...
  return (
    <div className={style.containerPrincipal}>
      <section className={style.containerOne}>
        ...
        <h1 className={style.second}>NaciónData</h1>
        
        <h3 className={style.three}>Descubre datos actualizados y relevantes en <span>NaciónData</span> ,tu fuente confiable para conocer la realidad de los países.</h3>
      </section>
